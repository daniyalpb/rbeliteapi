...
<p><span class="hidden-xs">Welcome : </span><b><?php echo e(Session::get('name')); ?></b></p>
 
</div>
</div>

<div class="col-md-1 col-xs-2 no-mob-pad"><a href="<?php echo e(url('log-out')); ?>" class="pull-right log-btn"><span class="logout-btn"><img src="images/icon/exit.png"></span></a></div>
