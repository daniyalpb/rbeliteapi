					...
					<div class="row">
						...
						<div class="col-md-6">
							<select type="text" name="docid" id="docid" class="form-control docid">
								...
								<?php $__currentLoopData = $docname; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($a->doc_id); ?>"><?php echo e($a->document_name); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div><br>
