            ...
            <div class="card-body">
              ...
              <p style='padding-top:10px;'>
              	...
              	<select name='product' id='product' class='form-control'>
              		...
              		<?php $__currentLoopData = $product_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $('#btn_submit_update').on('click' , function(){
    	...
    	$.ajax({
    		type : 'POST',
    		url : '<?php echo e(URL::to('update-product-city-price-mapping')); ?>',
    		data : formdata,
    		processData : false,
    		contentType : false,
    		success : function(response){
    ...
    $('#btn_submit_insert').on('click' , function(){
    	...
    	$.ajax({
    		type : 'POST',
    		url : '<?php echo e(URL::to('insert-product-city-price-mapping')); ?>',
    		data : formdata,
    		processData : false,
    		contentType : false,
    		success : function(response){
