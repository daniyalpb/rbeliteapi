...
height: 400px;">
					<table class="table table-bordered scroll-horizontal" id="docnameview">
					    ...
					    <tbody>
					      ...
					      <tr>
					        <td><?php echo e($val->doc_id); ?></td>
					        <td><?php echo e($val->document_name); ?></td>
					        <td><a href="<?php echo e($val->documenturl); ?>" target="_blank"><?php echo e($val->documenturl); ?></a></td>
					        <td><button type="button" class="btn btn-info doc_id" id="doc_id" value="<?php echo e($val->doc_id); ?>">Edit</button></td>
					        <td><button type="button" class="btn btn-danger del_doc_id" value="<?php echo e($val->doc_id); ?>">Delete</button></td>
					      </tr>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(url('document-master-save')); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="docupdate" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo e(url('document-master-update')); ?>" method="post" enctype="multipart/form-data">
					<?php echo e(csrf_field()); ?>
