		        ...
		        <div class="overflow-scroll">
					<div class="table-responsive">
						<table id="table_id" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap">
						    ...
						    <tbody>
						    	<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						        <tr>
						        <td class="text-wrap1"><?php echo e($val -> salesid); ?></td>
						            <td class="text-wrap1"><?php echo e($val -> name); ?></td>
						            ...
						            <td class="text-wrap1"><?php echo e($val -> rto_location); ?></td>
						            <td class="text-wrap1"><?php echo e($val -> agent_id); ?></td>
						            <td class="text-wrap1"><?php echo e($val -> ag_name); ?></td>
						            <td class="text-wrap1"><button type="button" value="<?php echo e($val->salesid); ?>" id="model" class="btn btn-info" value="" data-toggle="modal" data-target="#myModal">Assign</button></td>
						        </tr>
