...
class CustomerChatAppController extends Controller
{
    ...
    public function addComment(Request $req){
          ...
          $this->sendnotification($req->reqidadmin,$req->admincomment,$save[0]->token_id,$save[0]->chat_date_time,$save[0]->display_request_id);
    	  return $save; 
    }

    public function sendnotification($reqid,$msg,$token_id,$chat_date,$display_request_id){
        $to=$token_id;
        $notifyFlag='MSG';
        $imgurl='';
        $body='';
        ...
        $header=array("Content-Type:application/json",
          ...
          CURLOPT_POSTFIELDS =>"{\"to\":\"$to\",\"data\":{\"notifyFlag\":\"$notifyFlag\",\"img_url\":\"$imgurl\",\"body\":\"$body\",\"title\":\"$title\",\"chat\":{\"request_id\":\"$request_id\",\"message\":\"$message\",\"chat_date\":\"$chat_date\",\"type\":\"$type\",\"display_request_id\":\"$display_request_id\"}}}",
